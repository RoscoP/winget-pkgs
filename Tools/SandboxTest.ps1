...
function Get-ARPTable {
    ...
    return Get-ItemProperty `$registry_paths -ErrorAction SilentlyContinue |
        Where-Object { (`$_.PsObject.Properties.Name -eq 'DisplayName') -and `$_.DisplayName -and (-not (`$_.PsObject.Properties.Name -eq 'SystemComponent') -or `$_.SystemComponent -ne 1 ) } |
